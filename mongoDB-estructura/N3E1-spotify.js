...
db.artists.insertMany([
  { _id:ObjectId('0000000000000000000000b1'), nom: '', imatge: '',
    albums: [
      { _id_album:ObjectId('0000000000000000000000a1'), titol: '', any_pub: '', imatge: '',
        songs: [
          { _id:ObjectId('000000000000000000000001'), titol: '', durada: '', reproduccions: 599 },
          { _id:ObjectId('000000000000000000000002'), titol: '', durada: '', reproduccions: 300 },
        ],
      },
      { _id_album:ObjectId('0000000000000000000000a2'), titol: '', any_pub: '', imatge: '',
        songs: [
          { _id:ObjectId('000000000000000000000003'), titol: '', durada: '', reproduccions: 201 },
          { _id:ObjectId('000000000000000000000004'), titol: '', durada: '', reproduccions: 206 },
        ],
      },
    ],
  },
  { _id:ObjectId('0000000000000000000000b2'), nom: '', imatge: '',
    albums: [
      { titol: '', any_pub: '', imatge: '',
        songs: [
          { _id:ObjectId('000000000000000000000005'), titol: '', durada: '', reproduccions: 999 },
          { _id:ObjectId('000000000000000000000006'), titol: '', durada: '', reproduccions: 1234 },
        ],
      },
    ],
  },
...
db.usuaris.insertMany([
  { _id:ObjectId('0000000000000000000000d1'), tipus_user: '', email: '', password: '', nom_usuari: '', data_naixement: '', sexe: '', pais: '', codi_postal: '',
    playlists:[
      { owner_id:ObjectId('0000000000000000000000d1'), titol:"", num_cançons:"", data_creacio:"", data_eliminacio:"", tipus_playlist:"",
      canciones:[
  ...
  { _id:ObjectId('0000000000000000000000d2'), tipus_user: '', email: '', password: '', nom_usuari: '', data_naixement: '', sexe: '', pais: '', codi_postal: '',
    playlists:[
      { owner_id:ObjectId('0000000000000000000000d2'), titol:"", num_cançons:"", data_creacio:"", tipus_playlist:"",
      canciones:[
        {id_song:ObjectId('000000000000000000000001')},
        {id_song:ObjectId('000000000000000000000002')},
      ]}
